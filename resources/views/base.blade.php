                ...
                <div class="header__right ">
                    @if (Route::has('login'))
                        @auth
                            @if (Auth::user()->utype == 'adm')
                                <div class="row justify-content-center" style="margin-top: -12px">
                                    <ul class="header__right__widget">
                                        <li><span class="icon_search search-switch"></span></li>
                                        <li><a href="#"
                                                style="font-size: 13px !important;">Account({{ Auth::user()->name }})</a>
                                        </li>
                                        <li><a href="{{ route('admin.dashboard') }}"
                                                style="font-size: 12px !important;">Dashboard</a></li>
                                        <li>
                                            <a href="{{ route('logout') }}"
                                                onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                                                style="font-size: 12px !important;">Logout</a>
                                        </li>
                                ...
                                <div class="row justify-content-center mt-2">
                                    <ul class="header__right__widget">
                                        ...
                                        <li><a href="/shop"><span class="icon_bag_alt"></span>
                                                <div class="tip">4</div>
                                            </a></li>
                                    </ul>
                                </div>
                            @else
                                <div class="row justify-content-center" style="margin-top: -12px">
                                    <ul class="header__right__widget text-center">
                                        <li><span class="icon_search search-switch"></span></li>
                                        <li><a href="#"
                                                style="font-size: 12px !important;">Account({{ Auth::user()->name }})</a>
                                        </li>
